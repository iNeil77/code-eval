...
def get_dataset_metadata(name: str,
    ...
    assert name in ["wild-code-bench"], f"Unknown/unsupported dataset: {name}"
    extra = ""
    ...
    url = f"https://github.com/iNeil77/code-eval/releases/download/{version}/{name}{extra}.jsonl.gz"
